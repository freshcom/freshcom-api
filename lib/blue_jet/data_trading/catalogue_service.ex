defmodule BlueJet.DataTrading.CatalogueService do
  alias BlueJet.Catalogue.Customer
  ...
  @callback get_product_collection_membership(String.t, map) :: ProductCollectionMembership.t | nil
  ...
  defdelegate get_product_collection_membership(id, opts), to: @catalogue_service
