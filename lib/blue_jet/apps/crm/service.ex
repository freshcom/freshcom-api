defmodule BlueJet.Crm.Service do
  ...
  @callback update_customer(String.t | Customer.t, map, map) :: {:ok, Customer.t} | {:error, any}
  ...
  @callback update_point_transaction(String.t | PointTransaction.t, map, map) :: {:ok, PointTransaction.t} | {:error, any}
  @callback delete_point_transaction(Strint.t | PointTransaction.t, map) :: {:ok, PointTransaction.t} | {:error, any}
