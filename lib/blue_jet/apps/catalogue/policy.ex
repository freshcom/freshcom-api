defmodule BlueJet.Catalogue.Policy do
  ...
  def authorize(request = %{role: role}, "list_product")
  ...
  def authorize(request = %{role: role}, "create_product")
  ...
  def authorize(request = %{role: role}, "get_product")
      when role in ["support_specialist", "marketing_specialist", "developer", "administrator"] do
    {:ok, from_access_request(request, :get)}
  end

  def authorize(request = %{role: role}, "update_product")
      when role in ["marketing_specialist", "developer", "administrator"] do
    {:ok, from_access_request(request, :update)}
  end

  def authorize(request = %{role: role}, "delete_product")
      when role in ["marketing_specialist", "developer", "administrator"] do
  ...
  def authorize(request = %{role: role}, "create_price")
      when role in ["marketing_specialist", "developer", "administrator"] do
  ...
  def authorize(request = %{role: role}, "get_price")
      when role in ["marketing_specialist", "developer", "administrator"] do
    {:ok, from_access_request(request, :get)}
  end

  def authorize(request = %{role: role}, "update_price")
      when role in ["support_specialist", "marketing_specialist", "developer", "administrator"] do
    {:ok, from_access_request(request, :update)}
  end

  def authorize(request = %{role: role}, "delete_price")
      when role in ["marketing_specialist", "developer", "administrator"] do
    {:ok, from_access_request(request, :delete)}
  end
