defmodule BlueJet.Storefront.Service do
  ...
  @callback update_order(Order.t | map, map, map) :: {:ok, Order.t} | {:error, any}
  @callback delete_order(Order.t | map, map) :: {:ok, Order.t} | {:error, any}
  ...
  defdelegate update_order(identifiers_or_order, fields, opts), to: @service
  defdelegate delete_order(identifiers_or_order, opts), to: @service
