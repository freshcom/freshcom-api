defmodule BlueJet.Notification.Service do
  ...
  @callback update_email_template(String.t | EmailTemplate.t, map, map) :: {:ok, EmailTemplate.t} | {:error, any}
  @callback delete_email_template(String.t | EmailTemplate.t, map) :: {:ok, EmailTemplate.t} | {:error, any}
