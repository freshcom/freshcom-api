defmodule BlueJet.Authentication do
  ...
  def get_token(%{ "grant_type" => "password", "username" => username, "password" => password }, vas), do: get_token(%{ username: username, password: password, scope: nil }, vas)
  ...
  def get_token(%{ username: username, password: password, scope: scope }, vas) do
  ...
  def get_token(%{ username: username, password: password }, vas), do: get_token(%{ username: username, password: password, scope: nil }, vas)
  ...
  def extract_account_id(nil, %{ account_id: account_id }, _) do
    {:ok, account_id}
  end
