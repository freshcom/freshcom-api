...
#   def create(conn = %{ assigns: assigns = %{ vas: %{ account_id: _, user_id: _ } } }, %{ "data" => data = %{ "type" => "Order" } }) do
#     request = %{
#       vas: assigns[:vas],
...
#   def show(conn = %{ assigns: assigns = %{ vas: %{ account_id: _ } } }, %{ "id" => order_id }) do
#     request = %{
#       vas: assigns[:vas],
#       order_id: order_id,
#       preloads: assigns[:preloads],
...
#   def update(conn = %{ assigns: assigns = %{ vas: %{ account_id: _, user_id: _ } } }, %{ "id" => order_id, "data" => data = %{"type" => "Order" } }) do
#     request = %{
#       vas: assigns[:vas],
#       order_id: order_id,
#       fields: Params.to_attributes(data),
